						...
						<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										<span class="kt-portlet__head-icon">
											<i class="fas fa-shipping-fast" style="color: #265791;"></i>
										</span>
									...
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">
												...
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#new_driver_model">
									             <i class="la la-plus"></i> <?php echo $this->lang->line('label_add_driver'); ?>
												</button>
								...
								<div class="kt-portlet__body">
									...
									<!--begin: Datatable -->
									<table class="table table-striped- table-bordered table-hover table-checkable" id="driver">
										<thead>
											<tr>
...
<!-- Modal -->
<div class="modal fade" id="new_driver_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color: #265791;"><i class="fas fa-shipping-fast" style="color: #265791;"></i> <?php echo $this->lang->line('title_add_new_driver'); ?></h5>
      ...
      <div class="modal-body">
		    ...
		    <form method="post" id="FormDriver" role="form" name="FormDriver" class="kt-form kt-form--label-right">
		    	<div class="row">
		    		<div class="col-sm-12">
				...
				<!--begin::Form-->
					<div class="col-sm-6">
							<div class="kt-portlet__body">
								<div class="form-group row">
									<label for="example-text-input" class="col-4 col-form-label"><span id="astric">*</span> <?php echo $this->lang->line('label_driverid').'#'; ?>: </label>
									<div class="col-8">
										<input type="text" class="form-control m-input" name="item_number" id="item_number" placeholder="<?php echo $this->lang->line('label_item_number'); ?>" value="<?php echo $max_value; ?>" maxlength="128" disabled = "disabled">
                                          ...
                                          <input type="text" class="form-control m-input" name="item_number" id="item_number" placeholder="<?php echo $this->lang->line('label_item_number'); ?>" value="<?php echo $cref->id; ?>" maxlength="128" disabled = "disabled">
                                          <input type="hidden" name="item_number_hdn" id="item_number_hdn" value="">
									</div>
								</div>
								<div class="form-group row">
					...
					<div class="col-sm-6">
							<div class="kt-portlet__body">
								...
								<div class="form-group row">
									...
									<div class="col-8">
                                        <select class="form-control " name="country_driver" id="country_driver">
								...
								<div class="form-group row">
									<label for="branch" class="col-4 col-form-label"> <?php echo $this->lang->line('label_branch'); ?>: </label>
									<div class="col-8">
								...
								<div class="form-group row">
									<label for="email" class="col-4 col-form-label"><span id="astric">*</span> <?php echo $this->lang->line('label_password'); ?>: </label>
									<div class="col-8">
								...
								<div class="form-group row">
									<label for="website" class="col-4 col-form-label"><?php echo $this->lang->line('label_confirm_password'); ?>: </label>
									<div class="col-8">
								...
								<div class="form-group row">
									<label for="lic_id" class="col-4 col-form-label"><?php echo $this->lang->line('label_email'); ?>: </label>
									<div class="col-8">
				 ...
				 <input type="hidden" id="idDriver" name="idDriver" value="" class="form-control">
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-secondary" data-dismiss="modal"><?php echo $this->lang->line('label_back'); ?></button>
        <button type="submit" name="saveDriver" id="saveDriver" class="btn btn-success saveDriver"><?php echo $this->lang->line('label_submit'); ?></button>
      </div>
    </div>
		    </form>
  </div>
		...
		tableDriver = table.DataTable({
			...
			columns: [
				...
				//{data: 'Actions', responsivePriority: -1},
				{
                   data: function(datos) {
                         var accion = "";
                         accion += "<a href='#' class='btn btn-sm btn-clean btn-icon btn-icon-md edit_customer' data-toggle='modal' data-target='#new_driver_model'  value=" + datos.id + "  title='Editar' role='button' data-id=\"" + datos.id + "\"><i class='la la-edit'></i></a> ";
			...
			$('#generalSearchTable').on('keyup', function(e) {
				var $this = $(this);
				tableDriver.search($this.val()).draw();
			});
	};
